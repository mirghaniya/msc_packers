        ...
        <div className="relative overflow-hidden">
          ...
          >
            ...
            {[...brands, ...brands].map((brand, index) => (
              <div
                key={`${brand.id}-${index}`}
                className="flex-shrink-0 px-3 sm:px-4 md:px-8"
              ...
              >
                <div className="flex items-center justify-center h-24 sm:h-28 md:h-32">
                  <img
                    src={brand.logo_url}
                    alt={brand.name}
                    className="max-h-20 sm:max-h-24 md:max-h-28 max-w-full object-contain grayscale hover:grayscale-0 transition-all"
                  />
                </div>
              </div>
            ))}
