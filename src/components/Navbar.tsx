      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="flex items-center space-x-2 md:space-x-3 group">
            <img src={optimizedLogo} alt="MIRGHANIYA SUPER CENTRE" width={48} height={48} loading="eager" decoding="async" className="h-10 w-10 md:h-12 md:w-12 object-contain transition-transform group-hover:scale-105" />
